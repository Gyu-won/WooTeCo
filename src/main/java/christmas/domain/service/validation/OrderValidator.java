...
public class OrderValidator {
    ...
    private static Map<Menu, Integer> validateEachOrder(String ordersInput) {
        ...
        for (String order : splitOrder(ordersInput)) {
            ...
            Menu validMenu = checkDuplicate(MenuValidator.validate(menuAndCount.get(MENU)), orderMenus);
            orderMenus.put(validMenu, MenuCountValidator.validate(menuAndCount.get(COUNT)));
        }
        return orderMenus;
    }
