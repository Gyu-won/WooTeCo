...
public class HolidayDiscountServiceTest {
    ...
    public void 주말_이벤트_할인이_적용되는_날짜_테스트(Integer reserveDate) {
        //when
        boolean isWithinPeriod = HolidayDiscountService.isWithinPeriod(reserveDate);
    ...
    public void 주말_이벤트_할인금액을_계산한다(List<Menu> menus, Integer expectedDiscountAmount, Integer orderAmount) {
        ...
        //when
        Integer discountAmount = HolidayDiscountService.calculate(orderItems);
